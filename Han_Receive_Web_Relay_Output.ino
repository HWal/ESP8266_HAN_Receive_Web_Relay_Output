...
String listType = "xxxxxxxxxxxxxxx";// Type of the last read HAN List (see above)
String msgDate = "YYYY-MM-DD";      // HAN field - all list types
String msgTime = "hh:mm:ss";        // HAN field - all list types
String listVersion = "xxxxxxx";     // HAN field - list types 2 and 3 - 1&3 phase
String meterId = "xxxxxxxxxxxxxxxx";// HAN field - list types 2 and 3 - 1&3 phase
String meterModel = "xxxxxxxx";     // HAN field - list types 2 and 3 - 1&3 phase
